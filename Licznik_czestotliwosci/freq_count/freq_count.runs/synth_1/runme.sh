...
HD_PWD='C:/Users/kowal/Desktop/kowalski_267671_FPGA/freq_count/freq_count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FrequencyCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FrequencyCounter.tcl
