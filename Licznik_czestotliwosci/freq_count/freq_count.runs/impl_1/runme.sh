...
HD_PWD='C:/Users/kowal/Desktop/kowalski_267671_FPGA/freq_count/freq_count.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FrequencyCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FrequencyCounter.tcl -notrace
