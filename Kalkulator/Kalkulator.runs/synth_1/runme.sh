...
HD_PWD='D:/kowalski_267671_FPGA/UE2/Zad3Kalkulator/Kalkulator/Kalkulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_jednostka_arytmetyczna.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_jednostka_arytmetyczna.tcl
